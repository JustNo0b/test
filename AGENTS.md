...
Контент AI-помощник на Python 3.12+ — мониторинг ТГ-каналов и генерация еженедельных дайджестов.
...
- **Telegram API** (`TELEGRAM_API_ID`, `TELEGRAM_API_HASH`, `TELEGRAM_PHONE`) — для скрапинга каналов. Без них команда `scrape` не работает.
